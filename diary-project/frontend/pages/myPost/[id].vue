...
async function updateDiary() {
  ...
  const updateQuery:string=gql`
  mutation ($input: UpdateDiaryInput!) {
  ...
  await gqlRequest<fetchData, variables>({
    query: updateQuery,
    variables: updateInput,
    headers: header
  });

  navigateTo(`/diary/${DiaryID}`)
}
</script>
...
<template>
  ...
  <div class="flex" v-if="!isLoading">
    <div class="container">
      ...
      <form class="form" @submit.prevent="updateDiary">
